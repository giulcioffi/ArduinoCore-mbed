...
#define CLOCK_SOURCE                                                            USE_PLL_HSI                                                                                      // set by target:BORMIO
...
#define LPTICKER_DELAY_TICKS                                                    0                                                                                                // set by target:BORMIO
...
#define MBED_CONF_TARGET_LSE_AVAILABLE                                          0                                                                                                // set by target:BORMIO
#define MBED_CONF_TARGET_LSE_DRIVE_LOAD_LEVEL                                   RCC_LSEDRIVE_LOW                                                                                 // set by target:MCU_STM32H7
#define MBED_CONF_TARGET_MPU_ROM_END                                            0x0fffffff                                                                                       // set by target:Target
#define MBED_CONF_TARGET_SYSTEM_POWER_SUPPLY                                    PWR_LDO_SUPPLY                                                                                   // set by target:BORMIO
#define MBED_CONF_TARGET_TICKLESS_FROM_US_TICKER                                0                                                                                                // set by target:Target
#define MBED_CONF_TARGET_USB_SPEED                                              USE_USB_OTG_FS                                                                                   // set by target:BORMIO
