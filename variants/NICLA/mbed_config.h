...
#define BLE_GAP_HOST_PRIVACY_RESOLVED_CACHE_SIZE                                1                                                                                                // set by application[*]
#define BLE_GAP_MAX_ADVERTISING_REPORTS_PENDING_ADDRESS_RESOLUTION              0                                                                                                // set by application[*]
#define BLE_GAP_MAX_ADVERTISING_SETS                                            1                                                                                                // set by application[*]
...
#define BLE_SECURITY_DATABASE_FILESYSTEM                                        0                                                                                                // set by application[*]
#define BLE_SECURITY_DATABASE_KVSTORE                                           0                                                                                                // set by application[*]
...
#define DM_CONN_MAX                                                             1                                                                                                // set by application[*]
...
#define MBED_CONF_CORDIO_NORDIC_LL_HCI_DRIVER_BUFFER_SIZE                       13000                                                                                            // set by library:cordio-nordic-ll
...
#define MBED_CONF_RTOS_IDLE_THREAD_STACK_SIZE                                   512                                                                                              // set by application[*]
...
#define MBED_CONF_RTOS_MAIN_THREAD_STACK_SIZE                                   3072                                                                                             // set by application[*]
...
#define MBED_CONF_SPIF_DRIVER_SPI_CLK                                           SPI_PSELSCK0                                                                                     // set by library:spif-driver[NICLA]
#define MBED_CONF_SPIF_DRIVER_SPI_CS                                            CS_FLASH                                                                                         // set by library:spif-driver[NICLA]
#define MBED_CONF_SPIF_DRIVER_SPI_FREQ                                          40000000                                                                                         // set by library:spif-driver
#define MBED_CONF_SPIF_DRIVER_SPI_MISO                                          SPI_PSELMISO0                                                                                    // set by library:spif-driver[NICLA]
#define MBED_CONF_SPIF_DRIVER_SPI_MOSI                                          SPI_PSELMOSI0                                                                                    // set by library:spif-driver[NICLA]
